    ...
    <header class="header">
      ...
      <nav class="user-nav">
        <div class="user-nav__icon-box">
          ...
          <span class="user-nav__notification">
            7
          </span>
        </div>
        <div class="user-nav__icon-box">
        ...
        <div class="user-nav__user">
          <img src="./assets/images/user.png" class="user-nav__user-photo" alt="user-photo">
          <span class="user-nav__user-name">Light</span>
        </div>
      </nav>
    </header>
    <div class="content">
      <nav class="sidebar">
        <ul class="side-nav">
          ...
          <li class="side-nav__item">
            <a href="#" class="side-nav__link">
              <svg class="side-nav__icon">
                <use xlink:href="./assets/images/sprite.svg#icon-aircraft-take-off"></use>
              </svg>
              <span>Flight</span>
            </a>
          </li>
      ...
      <main class="hotel-view">
        <div class="gallery">
          <figure class="gallery__item">
            <img src="./assets/images/hotel-1.jpg" alt="Photo of hotel 1" class="gallery__photo">
          </figure>
          <figure class="gallery__item">
            <img src="./assets/images/hotel-2.jpg" alt="Photo of hotel 2" class="gallery__photo">
          </figure>
          <figure class="gallery__item">
            <img src="./assets/images/hotel-3.jpg" alt="Photo of hotel 3" class="gallery__photo">
          </figure>
        </div>
        ...
        <div class="overview">
          ...
          <div class="overview__location">
            <svg class="overview__icon-location">
              <use xlink:href="./assets/images/sprite.svg#icon-location-pin"></use>
            </svg>
        ...
        <div class="cta">
          <h2 class="cta__book-now">
            Good news! We have 4 free rooms for your selected detes!
          </h2>
          <button class="btn">
